    ...
    <div class="d-flex flex-column flex-center flex-column-fluid">
        ...
        <div class="d-flex flex-column flex-center text-center p-10">
            ...
            <div class="card card-flush w-lg-650px py-5">
                ...
                <!--end::Logo-->
                <!--begin::Title-->
                <h1 class="fw-bolder text-gray-900 mb-5">Yetkisiz Erişim!</h1>
                <!--end::Title-->
                <!--begin::Text-->
                <div class="fw-semibold fs-6 text-gray-500 mb-8">Ne yazık ki bu sayfayı görme yetkiniz bulunmamaktadır.</div>
                <!--end::Text-->
                <!--begin::Link-->
                <div class="mb-11">
