                    ...
                    <form action="{{ route('DigitalMenuCampaigns.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                ...
                                <input type="text" name="input-campaign_price" id="input-campaign_price" class="form-control @error('input-campaign_price') is-invalid error-input @enderror" placeholder="Kampamya Fiyatı Giriniz" maxlength="50" value="{{ old('input-campaign_price') }}"/>
