...
@section('PageTitle', 'Müşteri Ekleme')
    ...
    <div class="row g-5 g-xl-8">
        <div class="col-xl-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="{{ route('Clients.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <label for="input-email" class="required form-label">E-Posta Adresi</label>
                                <input type="email" name="input-email" id="input-email" class="form-control @error('input-email') is-invalid error-input @enderror" placeholder="E-Posta Adresi Giriniz" maxlength="50" value="{{ old('input-email') }}"/>
                                @if ($errors->has('input-email'))
                        ...
                        <div class="row mt-6">
                            <div class="col-6">
                                ...
                                <input type="text" name="input-first_name" id="input-first_name" class="form-control @error('input-first_name') is-invalid error-input @enderror" placeholder="Adı Giriniz" maxlength="50" value="{{ old('input-first_name') }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-last_name" id="input-last_name" class="form-control @error('input-last_name') is-invalid error-input @enderror" placeholder="Soyadı Giriniz" maxlength="50" value="{{ old('input-last_name') }}"/>
                        ...
                        <div class="row mt-6">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-company_name" id="input-company_name" class="form-control @error('input-company_name') is-invalid error-input @enderror" placeholder="İşletme Adı Giriniz" maxlength="500" value="{{ old('input-company_name') }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-6">
                                ...
                                <input type="text" name="input-company_address" id="input-company_address" class="form-control @error('input-company_address') is-invalid error-input @enderror" placeholder="İşletme Adresi Giriniz" maxlength="500" value="{{ old('input-company_address') }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-company_phone" id="input-company_phone" class="form-control @error('input-company_phone') is-invalid error-input @enderror" placeholder="İşletme Telefonu Giriniz" maxlength="500" value="{{ old('input-company_phone') }}"/>
