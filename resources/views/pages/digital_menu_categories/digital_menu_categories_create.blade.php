...
@section('PageTitle', 'Menü Kategorisi Ekleme')
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-success fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">Menü Kategorisi Bilgileri</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar"></div>
                </div>
                <div class="card-body">
                    <form action="{{ route('DigitalMenuCategories.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <label for="input-category_name" class="required form-label">Kategori Adı</label>
                                <input type="text" name="input-category_name" id="input-category_name" class="form-control @error('input-category_name') is-invalid error-input @enderror" placeholder="Kategori Adı Giriniz" maxlength="50" value="{{ old('input-category_name') }}"/>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" name="input-category_description" id="input-category_description" class="form-control @error('input-category_description') is-invalid error-input @enderror" placeholder="Kategori Açıklaması Giriniz" maxlength="50" value="{{ old('input-category_description') }}"/>
