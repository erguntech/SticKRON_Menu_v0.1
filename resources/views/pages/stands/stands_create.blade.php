...
@section('PageTitle', 'Stand Ekleme')
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-success fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">Stand Bilgileri</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar"></div>
                </div>
                <div class="card-body">
                    <form action="{{ route('Stands.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <label for="input-serial_no" class="required form-label">Stand Seri Numarası</label>
                                <input type="text" name="input-serial_no" id="input-serial_no" class="form-control @error('input-serial_no') is-invalid error-input @enderror" placeholder="Stand Seri Numarası Giriniz" maxlength="50" value="{{ old('input-serial_no') }}"/>
