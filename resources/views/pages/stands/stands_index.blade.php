...
@section('PageTitle', 'Stand Yönetimi')
        ...
        <div class="col-xl-12">
            ...
            <div class="card card-dashed" style="border-style: dotted">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-primary-active fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">Stand Tablosu</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar">
                        <a href="{{ route('Stands.Create') }}" class="btn btn-light-success btn-icon btn-sm">
...
@section('PageCustomJS')
    <script>
        var table, dt;
        var editUrl = '{{ route("Stands.Edit", ":id") }}';
    ...
    <script type="text/javascript">
        function deleteData(btn) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "stands/"+btn.getAttribute('data-id'),
                        type: 'DELETE',
                        data: {
