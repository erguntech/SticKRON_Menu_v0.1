...
@section('PageTitle', 'Menü İçeriği Ekleme')
        ...
        <div class="col-xl-12">
            <div class="card shadow-sm">
                <div class="card-header ribbon ribbon-start ribbon-clip">
                    <div class="ribbon-label bg-success fs-6" style="padding: 10px 15px;"><span class="d-flex text-white fw-bolder fs-6">Menü İçeriği Bilgileri</span></div>
                    <h3 class="card-title"></h3>
                    <div class="card-toolbar"></div>
                </div>
                <div class="card-body">
                    <form action="{{ route('DigitalMenuContents.Store') }}" id="createForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col-4">
                                <label for="input-content_name" class="required form-label">Ürün Adı</label>
                                <input type="text" name="input-content_name" id="input-content_name" class="form-control @error('input-content_name') is-invalid error-input @enderror" placeholder="Ürün Adı Giriniz" maxlength="50" value="{{ old('input-content_name') }}"/>
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="input-content_description" id="input-content_description" class="form-control @error('input-content_description') is-invalid error-input @enderror" placeholder="Ürün Açıklaması Giriniz" maxlength="50" value="{{ old('input-content_description') }}"/>
                            ...
                            <div class="col-12">
                                ...
                                <select class="form-select @error('input-digital_menu_category_id') is-invalid error-input @enderror" name="input-digital_menu_category_id" id="input-digital_menu_category_id" data-control="select2" data-placeholder="Seçim Yapınız" data-hide-search="true">
                                    ...
                                    @foreach($digitalMenuCategories as $digitalMenuCategory)
                                        <option value="{{ $digitalMenuCategory->id }}" @if (old('input-digital_menu_category_id') == $digitalMenuCategory->id) selected="selected" @endif>{{ $digitalMenuCategory->category_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                <label for="input-product_main_image" class="required form-label">Ürün Manşet Resmi</label>
