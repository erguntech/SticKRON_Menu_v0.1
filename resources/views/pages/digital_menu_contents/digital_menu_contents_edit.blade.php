                    ...
                    <form action="{{ route('DigitalMenuContents.Update', $digitalMenuContent->id) }}" id="editForm" enctype="multipart/form-data" method="POST" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="input-content_price" id="input-content_price" class="form-control @error('input-content_price') is-invalid error-input @enderror" placeholder="Ürün Fiyatı Giriniz" maxlength="50" value="{{ old('input-content_price', $digitalMenuContent->content_price) }}"/>
                        ...
                        <div class="row mt-6">
                            <div class="col-12">
                                <label for="input-product_main_image" class="required form-label">Ürün Manşet Resmi</label> <a class="text-primary" data-fslightbox="lightbox-basic" href="{{ Storage::url("uploads/products/".$digitalMenuContent->linked_client_id."/".$digitalMenuContent->id."/".$digitalMenuContent->id.".jpg") }}">(Mevcut Görsel Önizleme)</a>
